  ...
  return (
    <div className="pt-20 overflow-x-hidden">
      ...
      <section className="py-20 bg-gradient-to-br from-[#0D5D42] to-[#123D6A] relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <span className="block text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow'] mb-3">Healthcare Project</span>
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/donate" className="px-7 py-3 bg-[#D79A1E] text-white rounded-full font-bold font-['Raleway'] hover:bg-[#c08918] transition-all">
                Sponsor a Hospital Bed
              </Link>
              <Link href="/donate" className="px-7 py-3 bg-white/10 border border-white/20 text-white rounded-full font-semibold font-['Raleway'] hover:bg-white/20 transition-all">
                Donate to Hospital
              </Link>
            </div>
          </motion.div>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            >
              <p className="text-3xl font-black font-['Raleway']" style={{ color: stat.color }}>
                <AnimatedCounter end={stat.value} suffix={stat.suffix} />
              </p>
              <p className="text-gray-500 text-sm mt-1 font-['Barlow']">{stat.label}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <span className="text-red-500 font-semibold text-sm tracking-widest uppercase font-['Barlow']">The Problem</span>
            <h2 className="text-2xl font-black text-gray-900 mt-2 mb-5 font-['Raleway']">Healthcare Is a 15 km Drive Away</h2>
            <ul className="space-y-3">
              {[
                ...
                <li key={point} className="flex items-start gap-3 text-sm text-gray-600 font-['Barlow']">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.15 }}>
            <span className="text-[#0D5D42] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Our Solution</span>
            <h2 className="text-2xl font-black text-gray-900 mt-2 mb-5 font-['Raleway']">A Fully Equipped Rural Hospital</h2>
            <ul className="space-y-3">
              {[
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-xl font-black text-gray-900 font-['Raleway']">Villages in Coverage Area (5 km radius)</h2>
          </div>
          <div className="flex flex-wrap gap-3">
            {villages.map((v) => (
              <span key={v} className="px-5 py-2.5 bg-[#0D5D42]/10 text-[#0D5D42] rounded-full font-semibold font-['Barlow'] text-sm">{v}</span>
            ))}
          </div>
          <p className="text-gray-500 text-sm mt-4 font-['Barlow']">Location: Serugudi, Tiruchirappalli District, Tamil Nadu — 2 acres of land, ~50 cents built-up area</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Clinical Services</span>
            <h2 className="text-3xl font-black text-[#0D5D42] mt-2 font-['Raleway']">Comprehensive Rural Healthcare</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((svc, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 text-sm mb-2 font-['Raleway']">{svc.label}</h3>
                <p className="text-gray-500 text-xs leading-relaxed font-['Barlow']">{svc.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Project Budget</span>
            <h2 className="text-3xl font-black text-[#0D5D42] mt-2 font-['Raleway']">Total Estimated Cost: ₹4.5 – 5.5 Crore</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {costBreakdown.map((item, i) => (
              ...
              >
                <span className="text-gray-700 text-sm font-['Barlow']">{item.label}</span>
                <span className="font-bold text-[#0D5D42] font-['Raleway'] text-sm">{item.amount}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#0D5D42] to-[#123D6A]">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Implementation Roadmap</span>
            <h2 className="text-3xl font-black text-white mt-2 font-['Raleway']">3 Phases of Growth</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
            {phases.map((p, i) => (
              ...
              >
                <span className="text-[#D79A1E] text-xs font-bold font-['Barlow'] uppercase tracking-wide">{p.phase}</span>
                <h3 className="text-lg font-black text-white mt-2 mb-3 font-['Raleway']">{p.label}</h3>
                <p className="text-white/70 text-sm font-['Barlow'] leading-relaxed mb-4">{p.desc}</p>
                <span className={`px-3 py-1 rounded-full text-xs font-semibold font-['Barlow'] ${p.status === "Active" ? "bg-[#5AAE3D]/20 text-[#5AAE3D]" : p.status === "Planned" ? "bg-[#D79A1E]/20 text-[#D79A1E]" : "bg-white/10 text-white/60"}`}>
                  {p.status}
                </span>
              </motion.div>
            ))}
      ...
      <section className="py-20 bg-white text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto px-4">
          <h2 className="text-3xl font-black text-[#0D5D42] font-['Raleway'] mb-4">Help Build This Hospital</h2>
          <p className="text-gray-600 font-['Barlow'] mb-8">Sponsor a hospital bed (₹50,000), donate for equipment, or become a CSR partner. Every contribution saves lives.</p>
