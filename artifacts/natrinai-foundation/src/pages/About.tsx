    ...
    <div className="pt-20 overflow-x-hidden">
      ...
      <section className="py-20 bg-gradient-to-br from-[#0D5D42] to-[#123D6A] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Montserrat']">About Us</span>
            <h1 className="text-4xl sm:text-5xl font-black text-white mt-3 mb-5 font-['Poppins']">Our Story, Our Purpose</h1>
            <p className="text-white/75 text-lg font-['Inter'] max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Montserrat']">Our Story</span>
            <h2 className="text-3xl font-black text-[#0D5D42] mt-2 mb-5 font-['Poppins']">5 Years Before We Had a Name</h2>
              ...
              {timeline.map((item, i) => (
                <div key={item.year} className="flex gap-4">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-[#0D5D42] text-white flex items-center justify-center text-xs font-bold font-['Montserrat'] shrink-0">{i + 1}</div>
                    {i < timeline.length - 1 && <div className="w-0.5 bg-[#0D5D42]/20 flex-1 mt-1" />}
                  </div>
                  <div className="pb-4">
                    <p className="text-[#D79A1E] text-xs font-bold font-['Montserrat'] mb-1">{item.year}</p>
                    <p className="text-gray-600 text-sm font-['Inter'] leading-relaxed">{item.event}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
            {[
              ...
              >
                ...
                <h3 className="text-xl font-black mb-4 font-['Poppins']" style={{ color: item.color }}>{item.label}</h3>
                <p className="text-gray-600 leading-relaxed font-['Inter']">{item.text}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Montserrat']">Our Objectives</span>
            <h2 className="text-3xl sm:text-4xl font-black text-[#0D5D42] mt-2 font-['Poppins']">What We Are Working Toward</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {objectives.map((obj, i) => (
              ...
              >
                <h3 className="font-bold text-[#0D5D42] text-base mb-4 font-['Poppins']">{obj.area}</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-[#0D5D42] to-[#123D6A]">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-14">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Montserrat']">Governance</span>
            <h2 className="text-3xl sm:text-4xl font-black text-white mt-2 font-['Poppins']">Board of Trustees</h2>
            <p className="text-white/70 mt-3 font-['Inter']">The trust is managed by a dedicated Board of Trustees who govern all programs, finances, and strategic decisions.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7 mb-14">
            {trustees.map((trustee, i) => (
              ...
              >
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#D79A1E] to-[#c08918] flex items-center justify-center text-white text-2xl font-black font-['Poppins'] mx-auto mb-5">
                  {trustee.initials}
                </div>
                <p className="font-bold text-white text-base font-['Poppins']">{trustee.name}</p>
                <p className="text-[#D79A1E] text-sm mt-1 font-['Montserrat']">{trustee.role}</p>
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={item.label} className="flex items-start gap-4 p-5 bg-white/10 backdrop-blur rounded-2xl border border-white/10">
                ...
                <div>
                  <p className="font-bold text-white text-sm font-['Poppins']">{item.label}</p>
                  <p className="text-white/60 text-xs mt-1 font-['Inter']">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-white text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto px-4">
          <h2 className="text-3xl font-black text-[#0D5D42] font-['Poppins'] mb-4">Be Part of Our Journey</h2>
          <p className="text-gray-600 font-['Inter'] mb-8">Support our programs, volunteer your time, or partner with us for CSR initiatives.</p>
