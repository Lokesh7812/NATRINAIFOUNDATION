      ...
      <section className="py-20 bg-gradient-to-br from-[#0D5D42] to-[#123D6A] relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Space_Grotesk']">Support Our Mission</span>
            <h1 className="text-4xl sm:text-5xl font-black text-white mt-3 mb-5 font-['Syne']">Make a Donation</h1>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              <div key={item.label} className="flex items-center gap-2 text-sm font-semibold text-gray-600 font-['Space_Grotesk']">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm mb-7">
                <h2 className="text-xl font-black text-[#0D5D42] font-['Syne'] mb-6">Choose Your Contribution</h2>

                <div className="mb-6">
                  <p className="text-gray-600 text-sm font-['Plus_Jakarta_Sans'] mb-3">Select amount</p>
                  ...
                  <input
                    ...
                    className="mt-3 w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-800 font-['Plus_Jakarta_Sans'] text-sm outline-none focus:border-[#0D5D42] transition-colors"
                    data-testid="input-donate-custom"
                  />
                </div>

                <div className="mb-6">
                  <p className="text-gray-600 text-sm font-['Plus_Jakarta_Sans'] mb-3">Donate toward</p>
                ...
                {finalAmount > 0 && (
                  <div className="mb-6 p-4 bg-[#0D5D42]/5 rounded-xl border border-[#0D5D42]/10">
                    <p className="text-[#0D5D42] text-xs font-semibold font-['Space_Grotesk'] mb-2">YOUR IMPACT</p>
                    <ul className="space-y-1">
                      {impactItems[category].map((item) => (
                        <li key={item} className="text-gray-600 text-xs font-['Plus_Jakarta_Sans'] flex items-start gap-2">
              ...
              <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                <h2 className="text-xl font-black text-[#0D5D42] font-['Syne'] mb-6">Payment Methods</h2>
                ...
                <div className="space-y-5">
                  ...
                  <div className="p-6 rounded-2xl bg-[#0D5D42]/5 border border-[#0D5D42]/10">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="font-bold text-[#0D5D42] font-['Syne']">UPI Payment</h3>
                    </div>
                    <div className="flex items-center gap-3 p-3 bg-white rounded-xl border border-gray-200">
                      <span className="text-gray-800 text-sm font-mono flex-1">natrinaifoundation@upi</span>
                      <button
                        onClick={copyUPI}
                        className="flex items-center gap-1 px-3 py-1.5 bg-[#0D5D42] text-white rounded-lg text-xs font-semibold font-['Space_Grotesk'] hover:bg-[#0a4a35] transition-colors"
                    ...
                    <p className="text-gray-500 text-xs mt-3 font-['Plus_Jakarta_Sans']">Open any UPI app (GPay, PhonePe, Paytm, BHIM) and send to the above UPI ID.</p>
                  </div>
                  ...
                  <div className="p-6 rounded-2xl bg-[#123D6A]/5 border border-[#123D6A]/10">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="font-bold text-[#123D6A] font-['Syne']">Bank Transfer / NEFT / RTGS</h3>
                    </div>
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={row.label} className="flex justify-between text-sm">
                          <span className="text-gray-500 font-['Plus_Jakarta_Sans']">{row.label}</span>
                          <span className="font-semibold text-gray-800 font-['Plus_Jakarta_Sans']">{row.value}</span>
                        </div>
                      ))}
                    </div>
                    <p className="text-gray-500 text-xs mt-3 font-['Plus_Jakarta_Sans']">Please email your transaction receipt to info@natrinaifoundation.org for 80G receipt.</p>
                  </div>
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="font-black text-[#0D5D42] font-['Syne'] mb-5">Where Your Money Goes</h3>
              <div className="space-y-4">
                {allocationData.map((item) => (
                  <div key={item.label}>
                    <div className="flex justify-between text-sm mb-1.5">
                      <span className="text-gray-600 font-['Plus_Jakarta_Sans']">{item.label}</span>
                      <span className="font-bold font-['Syne']" style={{ color: item.color }}>{item.pct}%</span>
                    </div>
            ...
            >
              ...
              <h3 className="font-black font-['Syne'] mb-3">Tax Deduction Under 80G</h3>
              <p className="text-white/75 text-sm font-['Plus_Jakarta_Sans'] leading-relaxed mb-4">
              ...
              <div className="space-y-2">
                {["Send your PAN number with the donation", "We will issue an 80G receipt within 7 days", "Valid for individual and corporate donors"].map((pt) => (
                  <div key={pt} className="flex items-start gap-2 text-xs text-white/70 font-['Plus_Jakarta_Sans']">
            ...
            <motion.div
              ...
              className="bg-white rounded-3xl p-7 border border-gray-100 shadow-sm"
            >
              <h3 className="font-black text-[#0D5D42] font-['Syne'] mb-3">Need Help?</h3>
              <p className="text-gray-600 text-sm font-['Plus_Jakarta_Sans'] mb-4">For large donations, CSR partnerships, or any queries about your contribution:</p>
