  ...
  return (
    <div className="pt-20 overflow-x-hidden">
      ...
      <section className="py-20 bg-gradient-to-br from-[#5AAE3D] to-[#0D5D42] relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <span className="block text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow'] mb-3">Rural Development</span>
            <h1 className="text-4xl sm:text-5xl font-black text-white font-['Raleway'] mb-5 leading-tight">
              Hut to Home Initiative
            </h1>
            <p className="text-white/85 text-lg font-['Barlow'] max-w-2xl leading-relaxed mb-8">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <span className="text-red-500 font-semibold text-sm tracking-widest uppercase font-['Barlow']">The Challenge</span>
            <h2 className="text-2xl font-black text-gray-900 mt-2 mb-5 font-['Raleway']">Hundreds of Families in Fragile Shelter</h2>
            <p className="text-gray-600 leading-relaxed font-['Barlow'] mb-5">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.15 }}>
            <div className="bg-[#5AAE3D]/10 rounded-3xl p-8">
              ...
              <h3 className="font-black text-[#0D5D42] text-lg font-['Raleway'] mb-3">Pilot Success Story</h3>
              <p className="text-gray-700 text-sm font-['Barlow'] leading-relaxed mb-4">
              ...
              <p className="text-gray-600 text-sm font-['Barlow'] italic">
              ...
              <p className="text-[#5AAE3D] text-xs font-semibold font-['Barlow'] mt-2">— Pilot beneficiary, Tiruchirappalli</p>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Selection</span>
            <h2 className="text-3xl font-black text-[#0D5D42] mt-2 font-['Raleway']">Beneficiary Selection Criteria</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {criteria.map((c, i) => (
              ...
              >
                ...
                <span className="text-gray-700 text-sm font-['Barlow']">{c}</span>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Our Process</span>
            <h2 className="text-3xl font-black text-[#0D5D42] mt-2 font-['Raleway']">From Survey to Handover in 60 Days</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {process.map((p, i) => (
              ...
              >
                <div className="w-14 h-14 rounded-2xl bg-[#5AAE3D] text-white flex items-center justify-center text-xl font-black font-['Raleway'] mx-auto mb-4">
                  {p.step}
                </div>
                <h3 className="font-bold text-gray-900 text-sm mb-2 font-['Raleway']">{p.label}</h3>
                <p className="text-gray-500 text-xs leading-relaxed font-['Barlow']">{p.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-[#0D5D42]">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-10">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Cost Breakdown</span>
            <h2 className="text-3xl font-black text-white mt-2 font-['Raleway']">₹3 Lakh Builds One Home</h2>
          </motion.div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {budget.map((item, i) => (
              <motion.div
              ...
              >
                <span className="text-white/80 text-sm font-['Barlow']">{item.item}</span>
                <span className="font-bold text-[#D79A1E] font-['Raleway']">{item.cost}</span>
              </motion.div>
            ))}
          </div>
          <div className="mt-6 p-5 bg-[#D79A1E] rounded-xl flex justify-between items-center">
            <span className="text-white font-bold font-['Raleway']">Total per Home</span>
            <span className="text-white font-black text-xl font-['Raleway']">~₹3,50,000</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto px-4">
          ...
          <h2 className="text-3xl font-black text-[#0D5D42] font-['Raleway'] mb-4">Donate a Home Today</h2>
          <p className="text-gray-600 font-['Barlow'] mb-8">₹3,50,000 builds a family a permanent home. You can donate the full amount, or contribute toward a home with any amount — we will combine contributions to complete each house.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/donate" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-[#0D5D42] text-[#0D5D42] rounded-full font-semibold font-['Raleway'] hover:bg-[#0D5D42] hover:text-white transition-all">
