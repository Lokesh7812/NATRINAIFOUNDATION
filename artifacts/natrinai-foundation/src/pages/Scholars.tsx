    ...
    <div className="pt-20 overflow-x-hidden">
      ...
      <section className="py-20 bg-gradient-to-br from-[#D79A1E] to-[#c08918] relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <Link href="/projects" className="inline-flex items-center gap-2 text-white/70 hover:text-white text-sm font-['Barlow'] mb-6 transition-colors">
              ← All Projects
            </Link>
            <span className="block text-white/80 font-semibold text-sm tracking-widest uppercase font-['Barlow'] mb-3">Education Project</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/donate" className="inline-flex items-center gap-2 px-7 py-3 bg-white text-[#D79A1E] rounded-full font-bold font-['Raleway'] hover:bg-white/90 transition-all">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">The Model</span>
            <h2 className="text-3xl font-black text-[#0D5D42] mt-2 mb-5 font-['Raleway']">52 Weeks. 52 Lives Changed.</h2>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.15 }}>
            <div className="space-y-5">
              {steps.map((step, i) => (
                ...
                >
                  <div className="w-10 h-10 rounded-xl bg-[#D79A1E] text-white flex items-center justify-center font-black text-sm font-['Raleway'] shrink-0">
                    {step.step}
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 text-sm mb-1 font-['Raleway']">{step.title}</h3>
                    <p className="text-gray-500 text-xs leading-relaxed font-['Barlow']">{step.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
            <span className="text-[#D79A1E] font-semibold text-sm tracking-widest uppercase font-['Barlow']">Program Pillars</span>
            <h2 className="text-3xl font-black text-[#0D5D42] mt-2 font-['Raleway']">A Complete Support System</h2>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {pillars.map((pillar, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-gray-900 text-sm mb-2 font-['Raleway']">{pillar.label}</h3>
                <p className="text-gray-500 text-xs leading-relaxed font-['Barlow']">{pillar.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-[#0D5D42] text-center">
        <div className="max-w-3xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <p className="text-white/60 text-xs font-semibold tracking-widest uppercase font-['Barlow'] mb-4">In Partnership With</p>
            <h3 className="text-2xl font-black text-white font-['Raleway'] mb-3">Dr. Abdul Kalam Dream Foundation</h3>
            <p className="text-white/70 font-['Barlow'] text-base">Together, we are building the mentorship infrastructure that transforms scholarship recipients into India's next generation of doctors, engineers, scientists, and leaders.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-2xl mx-auto px-4">
          <h2 className="text-3xl font-black text-[#0D5D42] font-['Raleway'] mb-4">Fund a Scholar's Future</h2>
          <p className="text-gray-600 font-['Barlow'] mb-8">₹12,000 supports one scholar for a full year. Your contribution can be the reason someone becomes a doctor, engineer, or scientist.</p>
          <Link href="/donate" className="inline-flex items-center gap-2 px-8 py-4 bg-[#D79A1E] text-white rounded-full font-bold font-['Raleway'] hover:bg-[#c08918] transition-all text-lg">
